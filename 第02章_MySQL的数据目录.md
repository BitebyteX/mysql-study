...
![image-20220709112825432](第02章_MySQL的数据目录.assets/image-20220709112825432.png)
...
![](第02章_MySQL的数据目录.assets/MySQL5.7下数据库的目录结构.png)

![](第02章_MySQL的数据目录.assets/MySQL8.0下数据库的数据目录（InnoDB）.png)
